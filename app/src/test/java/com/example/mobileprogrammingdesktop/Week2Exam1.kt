...
fun main(){
    ...
    File("C:\\Users\\s_vpfxm0831\\Desktop\\MobileProgramming\\DESKTOP\\app\\src\\test\\java\\com\\example\\mobileprogrammingdesktop\\words2.txt").useLines { lines -> lines.forEach { wordsList.add(it) }}
